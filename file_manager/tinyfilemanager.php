...
//Application Title
define('APP_TITLE', 'Mamamoorental File Manager');
...
$root_path = $_SERVER['DOCUMENT_ROOT'].'/file/site';
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            $techno = "<a href='Admin' style='margin-right:5px;'><i class='fa fa-desktop' aria-hidden='true' title='Back to dashboard'></i></a>";
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Mamamoorental File Manager';      $tr['en']['AppTitle']           = 'Mamamoorental File Manager';
