...
<div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-2">
  <div class="mr-4 mb-3 mb-sm-0">
    <h1 class="mb-0">Transaksi sedang DIKIRIM</h1>
    <div class="small">
          ...
          <tbody>
            <?php if ($pesanan == false) { echo "<tr><td colspan='8'><center>Belum ada data</center></td></tr>";}else{ $no = 1; foreach ($pesanan as $data) {?>
              <tr>
                ...
                <td>
                  <?php if(empty($data->WAKTU_PENGIRIMAN) || $data->WAKTU_PENGIRIMAN == null){ echo '<span class="text-info">Menunggu proses sebelumnya</span>';}else{ echo '<span class="text text-warning font-weight-bold">Pukul '.str_replace(", ", " - Tanggal: ", $data->WAKTU_PENGIRIMAN).'</span> WIB';};?>
                  </td>
                </tr>
                <!-- MODAL karya -->
