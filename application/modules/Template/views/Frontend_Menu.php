        ...
        <div class="menu-container wd-megamenu">
          <div class="menu">
            <ul class="wd-megamenu-ul">
              ...
              <li><a href="compare-products.html" class="main-menu-list">Produk <i class="fa fa-angle-down angle-down" aria-hidden="true"></i></a>
              ...
              <li class="pos-inherit"><a href="shop-left-sidebar.html" class="main-menu-list ">Shortcode <i class="fa fa-angle-down angle-down" aria-hidden="true"></i></a>
                <ul class="single-dropdown megamenu">
                  ...
                  <li>
                    <a href="product-details-scroll.html" class="add-img"><img src="<?php echo base_url();?>assets/frontend/img/nav-img-1.jpg" class="figure-img img-fluid" alt="Product Img"></a>
                    <a href="product-details-scroll.html" class="add-img"><img src="<?php echo base_url();?>assets/frontend/img/nav-img-2.jpg" class="figure-img img-fluid" alt="Product Img"></a>
                  </li>
                </ul>
              </li>
                            ...
                            <div class="tab-pane fade show active" id="login-2" role="tabpanel" aria-labelledby="login-tab-2">
                              ...
                              <div class="row">
                                <div class="col-md-6 p0 brand-description-area">
                                  <img src="<?php echo base_url();?>assets/frontend/img/login-img-1.jpg" class="img-fluid" alt="">
                            ...
                            <div class="tab-pane fade" id="sign-up-2" role="tabpanel" aria-labelledby="sign-up-tab-2">
                              ...
                              <div class="row">
                                <div class="col-md-12 p0 brand-login-section">
                                  <img src="<?php echo base_url();?>assets/frontend/img/login-img-2.jpg" class="img-fluid" alt="">
                                  <div class="brand-description">
                                    <div class="brand-logo">
                                      <img src="<?php echo base_url();?>assets/frontend/img/logo.png" alt="Logo">
                                    </div>
