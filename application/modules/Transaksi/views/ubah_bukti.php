  ...
  <div class="row mt-5">
    ...
    <div class="col-md-8 offset-md-2 col-sm-12">
      <div class="p-card mb-3">
        <form action="<?php echo site_url('KirimUbah');?>" method="post" enctype="multipart/form-data">
          <input type="hidden" name="transaksi" value="<?= $transaksi->KODE_TRANSAKSI;?>">
          <div class="p-card-body">
            <div class="row">
              <div class="col-sm-12">
                <div class="my-account-section__header-title">Ubah bukti TRANSFER PEMBAYARAN</div>
            ...
            <div class="row mb-3">
              <div class="col-sm-12 text-dark">
                <span class="text-secondary">Harap upload ulang bukti transfer anda dikarenakan: <span class="text-danger"><?= $transaksi->bukti_komen;?></span></span>
              </div>
            </div>
            <div class="row mb-3">
              <div class="col-sm-3">
              ...
              <div class="col-sm-9 text-dark">
                <img id="previewBukti" class="mb-2 previewImg bukti" src="<?php echo base_url();?>file/site/pengguna/<?php echo $transaksi->KODE_PERSONAL;?>/bukti_bayar/<?php echo $transaksi->bukti;?>" alt="Placeholder">
