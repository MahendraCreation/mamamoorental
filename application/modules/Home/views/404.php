...
<head>
  ...
  <title>404 Error - Mamamoorental</title>
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-6 text-md-right small">
              <a href="<?php echo base_url();?>assets/backend/<?php echo site_url('KebijakandanPrivasi');?>">Kebijakan Privasi</a>
              &#xB7;
              <a href="<?php echo base_url();?>assets/backend/<?php echo site_url('SyaratdanKetentuan');?>">Syarat dan Ketentuan</a>
            </div>
          </div>
        </div>
      </footer>
